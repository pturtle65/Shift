...
{
    [TestClass]
    public class LiteDBJobClientTest
    {
        JobClient jobClient;
        const string appID = "TestAppID";

        public LiteDBJobClientTest()
        {
            //Configure storage connection
            var config = new ClientConfig();
            config.DBConnectionString = @"Data Source=C:\projects\Github\Shift\Shift.UnitTest\testdatabase.litedb.db";
            config.StorageMode = "litedb";
